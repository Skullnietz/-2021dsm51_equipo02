  ...
  <main>
     ...
     <div class="py-5 text-center">
      ...
      <div class="col-lg-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate="" action="{{route('productos.update2', $producto)}}" method="post" enctype="multipart/form-data">
            @csrf @method('PATCH')
          <div class="row g-3">
            <div class="col-6">
              <label for="firstName" class="form-label">Producto</label>
              <input type="text" class="form-control" id="producto" name="producto" placeholder="Nombre de producto" value="{{$producto->producto }}" required="">
            ...
            <div class="col-6">
              ...
              <input type="text" class="form-control" id="costo" name="costo" placeholder="Costo de producto" value="{{$producto->costo }}" required="">
                @error('costo')
                <br>
                <small style="color:#F00";>*{{$message}}</small>
                <br>
            ...
            <div class="col-6">
                ...
                <input type="file" class="form-control" id="img" name="img" placeholder="Imagen" value="{{$producto->img }}" required="" accept="image/*">
                  @error('img')
                  <br>
                  <small style="color:#F00";>*{{$message}}</small>
                  <br>
              ...
              <div class="col-6">
                ...
                <input type="text" class="form-control" id="existencias" name="existencias" placeholder="Existencias" value="{{$producto->existencias }}" required="">
                  @error('existencias')
                  <br>
                  <small style="color:#F00";>*{{$message}}</small>
                  <br>
              ...
              <div class="col-6">
                ...
                <textarea type="text" rows="3" class="form-control" id="descripcion" name="descripcion" placeholder="{{$producto->descripcion }}" value="" required="">{{$producto->descripcion }}</textarea>
                  @error('descripcion')
                  <br>
                  <small style="color:#F00";>*{{$message}}</small>
                  <br>
