...
<div class="container">
  <main>
    ...
    <div class="col-lg-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate="" action="{{route('users.update2', $user )}} " method="post">
            @csrf @method('PATCH')
          <div class="row g-3">
            <div class="col">
              <label for="firstName" class="form-label">Nombre(s)</label>
              <input type="text" class="form-control" id="nombre" name="name" placeholder="Tu nombre" value="{{$user->name }}" required="">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" id="app" name="primer_apellido" placeholder="Tu Primer Apellido" value="{{$user->primer_apellido }}" required="">
              ...
              <input type="text" class="form-control" id="apm" name="segundo_apellido" placeholder="Tu Segundo Apellido" value="{{$user->segundo_apellido }}" required="">
            ...
            <div class="col-12">
              ...
              <input type="email" class="form-control" id="mail" name="email" placeholder="correo@dominio.com" value="{{$user->email }}">
            ...
            <div class="form-group row">
                ...
                <div></div>
                <div class="col-10">
                  <input class="form-control" id="fn" name="fecha_nacimiento" type="date" value="{{$user->fecha_nacimiento }}" >
