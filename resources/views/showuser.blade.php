    ...
    <section class="seccion-perfil-usuario">
        ...
        <div class="perfil-usuario-body">
            <div class="perfil-usuario-bio">
                <h3 class="titulo">{{$user->name }} {{$user->primer_apellido }} {{$user->segundo_apellido }}</h3>
            ...
            <div class="perfil-usuario-footer">
                <ul class="lista-datos">
                    ...
                    <li style="color:#00F";>{{$user->perfil }}</li>
                    <li><i class="icono fas fa-edit"></i> Nombre:</li>
                    <li style="color:#00F";>{{$user->name }} {{$user->primer_apellido }} {{$user->segundo_apellido }}</li>
                    <li><i class="icono fas fa-edit"></i> Sexo:</li>
                    <li style="color:#00F";>{{$user->sexo }}</li>
                </ul>
                <ul class="lista-datos">
                    <li><i class="icono fas fa-clipboard"></i> Estatus:</li>
                    <li style="color:#00F";>{{$user->estatus }}</li>
                    <li><i class="icono fas fa-edit"></i>Fecha nacimiento:</li>
                    <li style="color:#00F";>{{$user->fecha_nacimiento }}</li>
                    <li><i class="icono fas fa-user-plus"></i> Creado:</li>
                    <li style="color:#00F";>{{$user->created_at }}</li>
                    <li><i class="icono fas fa-sync-alt"></i> Actualizado:</li>
                    <li style="color:#00F";>{{$user->updated_at }}</li>

                </ul>
                <a class="w-100 btn btn-primary btn-lg" href="{{route('editarusu2')}}" ><i class="fas fa-tools"></i> Editar Mi Perfil</a>
            </div>
